  ...
  return (
    ...
    <div class="martix-container">
      ...
      <div class="matrix-board">
        ...
        <div class="matrix-box">House1</div>
        <div class="matrix-box">Restaurant</div>
        <div class="matrix-box">Gym</div>
        <div class="matrix-box">Hospital</div>
        <div class="matrix-box">Restaurant</div>
        <div class="matrix-box">Gym</div>
        <div class="matrix-box">Restaurant</div>
        <div class="matrix-box">Gym</div>
        <div class="matrix-box">House2</div>
      </div>
